...
export class BridgeHost {
  ...
  private static readonly HAPTIC_PATTERNS: Record<string, { style: Haptics.ImpactFeedbackStyle; count: number }> = {
    ...
    // ─── TidyMaster ───
    'item-tapped':            { style: Haptics.ImpactFeedbackStyle.Heavy, count: 1 },
    'shelf-correct':          { style: Haptics.ImpactFeedbackStyle.Heavy, count: 6 },
    'shelf-wrong':            { style: Haptics.ImpactFeedbackStyle.Heavy, count: 3 },
    'stage-clear-tidymaster': { style: Haptics.ImpactFeedbackStyle.Heavy, count: 3 },
    // ─── Chess ───
