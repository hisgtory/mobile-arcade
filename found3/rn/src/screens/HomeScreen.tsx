...
import { StyleSheet, View, Text, TouchableOpacity, ImageBackground, Image, Platform, Modal, Animated, Vibration } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 40, marginTop: -50 },
  ...
  stageCard: { backgroundColor: 'rgba(255, 255, 255, 0.95)', width: '100%', padding: 30, borderRadius: 40, alignItems: 'center', marginBottom: 50, shadowColor: '#000', shadowOffset: { width: 0, height: 15 }, shadowOpacity: 0.1, shadowRadius: 25, elevation: 8 },
