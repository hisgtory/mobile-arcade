...
import { StyleSheet, View, Text, TouchableOpacity, ImageBackground, Image, Platform, Modal, Animated, Vibration, Pressable } from 'react-native';
    ...
    <ImageBackground source={TILE_ASSETS['background']} style={styles.background} resizeMode="cover">
      <SafeAreaView style={styles.safeArea} edges={['bottom', 'left', 'right']}>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.duoModalDepth}>
              <View style={styles.duoModalInner}>
                ...
                {/* Fixed height button container to prevent layout jumping */}
        ...
        <View style={styles.content}>
          ...
          {/* Fixed height wrapper for Play Button */}
