...
// ─── Minesweeper ───
import { HUD as MinesweeperHUD } from './games/minesweeper/HUD';
...
// ─── Sudoku ───
import { ClearScreen as SudokuClear } from './games/sudoku/ClearScreen';
import { HUD as SudokuHUD } from './games/sudoku/HUD';
import { NumberPad as SudokuNumberPad } from './games/sudoku/NumberPad';
import { useGame as useSudokuGame, type GameResult as SudokuResult } from './games/sudoku/useGame';
...
export function App() {
  ...
  return (
    <Routes>
      ...
      {/* Sudoku */}
      <Route path="/games/sudoku/v1" element={<SudokuTitleRoute />} />
      <Route path="/games/sudoku/v1/stage/:stageId" element={<SudokuStageRoute />} />
