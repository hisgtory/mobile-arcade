...
const GRID_OPTIONS = [
  { label: '3×3', desc: 'Classic' },
  { label: '4×4', desc: 'After 3 wins' },
  { label: '5×5', desc: 'After 6 wins' },
] as const;
          ...
          {GRID_OPTIONS.map((opt, i) => (
            <button
              ...
              style={{
                ...
                padding: '16px 8px',
                borderRadius: 16,
                border: selected === i ? '2px solid #2563EB' : '2px solid #E5E7EB',
                backgroundColor: selected === i ? '#EFF6FF' : '#fff',
                cursor: 'pointer',
                textAlign: 'center',
              }}
            >
