...
const styles = StyleSheet.create({
  ...
  volBtn: { width: 36, height: 36, backgroundColor: '#F7F7F7', borderRadius: 10, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#E5E5E5' },
  volBtnText: { fontSize: 22, fontFamily: 'Nunito-Black', color: '#4B4B4B', textAlignVertical: 'center', includeFontPadding: false, marginTop: Platform.OS === 'ios' ? -3 : 0 },
