...
import { StyleSheet, View, Text, Modal, TouchableOpacity, Dimensions, ImageBackground, Animated, Vibration, Platform, Image, ActivityIndicator } from 'react-native';
...
export const GameBoard: React.FC<GameBoardProps> = ({ 
  ...
  const boardAvailH = SCREEN_HEIGHT - 430; 
          ...
          <View style={[styles.modalContent, styles.shopContent]}>
            ...
            <View style={styles.shopItemList}>
              <View style={styles.shopItem}>
                ...
                <View style={styles.shopItemInfo}><Text style={styles.shopItemName}>UNDO</Text><Text style={styles.shopItemPrice}>🪙 {ITEM_PRICES.undo}</Text></View>
                <TouchableOpacity style={styles.buyBtn} onPress={() => buyItem('undo')}><Text style={styles.buyBtnText}>BUY</Text></TouchableOpacity>
              </View>
              <View style={styles.shopItem}>
                <Image source={TILE_ASSETS['item_shuffle']} style={styles.shopItemIcon} />
                <View style={styles.shopItemInfo}><Text style={styles.shopItemName}>SHUFFLE</Text><Text style={styles.shopItemPrice}>🪙 {ITEM_PRICES.shuffle}</Text></View>
                <TouchableOpacity style={styles.buyBtn} onPress={() => buyItem('shuffle')}><Text style={styles.buyBtnText}>BUY</Text></TouchableOpacity>
              </View>
              <View style={styles.shopItem}>
                <Image source={TILE_ASSETS['ui_magnet']} style={styles.shopItemIcon} />
                <View style={styles.shopItemInfo}><Text style={styles.shopItemName}>MAGNET</Text><Text style={styles.shopItemPrice}>🪙 {ITEM_PRICES.magnet}</Text></View>
                <TouchableOpacity style={styles.buyBtn} onPress={() => buyItem('magnet')}><Text style={styles.buyBtnText}>BUY</Text></TouchableOpacity>
              </View>
            </View>
            <TouchableOpacity style={styles.closeButton} onPress={() => setShowShop(false)}><Text style={styles.closeButtonText}>BACK TO GAME</Text></TouchableOpacity>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  stageText: { fontSize: 26, fontWeight: '900', color: '#333' },
  coinBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255, 255, 255, 0.8)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 15, marginRight: 10, borderWidth: 1, borderColor: '#FFD700' },
  coinIcon: { fontSize: 16, marginRight: 4 },
  coinText: { fontSize: 14, fontWeight: 'bold', color: '#333' },
  ...
  volumeController: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: 150 },
  volBtn: { width: 32, height: 32, backgroundColor: '#f1f3f5', borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
  volBtnText: { fontSize: 18, fontWeight: 'bold', color: '#495057' },
  volProgressBg: { flex: 1, height: 8, backgroundColor: '#dee2e6', borderRadius: 4, marginHorizontal: 8, overflow: 'hidden' },
