/**
 * Tile game object for Candy Friends
 *
...
export class Tile extends Phaser.GameObjects.Container {
  ...
  constructor(
    ...
    // Background — soft pink candy theme
    this.bg = scene.add.rectangle(0, 0, size - 2, size - 2, 0xfff0f5, 1);
    this.bg.setStrokeStyle(1, 0xf9a8d4, 0.8);
    this.add(this.bg);
