...
const STAGES: StageConfig[] = [
  { stage: 1, typeCount: 4, rows: 7, cols: 7, maxMoves: 25, targetScore: 800, minGroupSize: 2 },
  { stage: 2, typeCount: 5, rows: 7, cols: 7, maxMoves: 22, targetScore: 1500, minGroupSize: 2 },
  ...
  { stage: 5, typeCount: 6, rows: 9, cols: 9, maxMoves: 20, targetScore: 6000, minGroupSize: 3 },
];
